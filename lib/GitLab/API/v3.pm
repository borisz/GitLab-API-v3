...
sub unprotect_branch {
    my $self = shift;
    croak 'unprotect_branch must be called with 2 to 3 arguments' if @_ < 2 or @_ > 3;
    ...
    croak 'The last argument (\%params) to unprotect_branch must be a hash ref' if defined($_[2]) and ref($_[2]) ne 'HASH';
    my $params = (@_ == 3) ? pop() : undef;
